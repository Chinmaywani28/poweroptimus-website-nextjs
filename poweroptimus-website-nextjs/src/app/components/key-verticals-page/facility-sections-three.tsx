...
import './facility-sections-three.css'; // Import HomePage specific styles


const FacilitySectionsThree = ({ title,subTitle,subTitleTwo, text , textArr, imageSrc, reverse,label1,label2,label3,listOne,listTwo,listThree,listFour,tagPath1,tagPath2,tagPath3 }: {
  title: string;
  subTitle: string;
  subTitleTwo: string;
  textArr: any;
...
export default FacilitySectionsThree