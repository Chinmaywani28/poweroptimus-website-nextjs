...
const SustainableGoalsTwo: React.FC = () => {
  ...
  const sdgData = [
    ...
    },
    {
      ...
      description:
        "Through digitalization and smart automation, PowerOptimus strengthens industrial infrastructure. Equipment-level monitoring, predictive analytics, and intelligent dashboards enable proactive maintenance, reduced downtime, and continuous performance optimization—building resilient and future-ready operations.",
      impact:
    ...
    },
    {
      ...
      description:
        "PowerOptimus enables responsible resource management by providing granular visibility into energy, utilities, and environmental parameters. Continuous benchmarking, loss detection, and performance tracking help organizations minimize waste, optimize processes, and improve resource efficiency.",
      impact:
    ...
    },
    {
      ...
      description:
        "The platform empowers organizations to take measurable climate action through emissions tracking, environmental monitoring, and automated sustainability reporting. By linking operational data with carbon metrics, PowerOptimus helps identify reduction opportunities and support long-term decarbonization strategies.",
      impact:
  ...
  return (
    <section>
      <div className={`${styles.sectionName} body2 marTopGlobal`}>
        PowerOptimus enables organizations to convert sustainability commitments
      ...
      <div className={`${styles.grid} marTopGlobal`}>
...
export default SustainableGoalsTwo;
