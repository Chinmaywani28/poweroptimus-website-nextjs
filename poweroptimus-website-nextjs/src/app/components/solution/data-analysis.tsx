  ...
  return (
    <section className="data-section">
      ...
      <p className="data-subtitle body2 TextGray1">
        PowerOptimus combines advanced data analytics and visualization to enhance modern energy management solution.
       It collects data from real-time energy meters and environmental sensors to deliver clear, actionable insights.
        ...
        Designed with sustainability in mind, PowerOptimus – an environmental monitoring solution tracks emissions, air quality, and resource use, empowering organizations to lower their carbon footprint and stay compliant with environmental standards.
      </p>
