...
const DeviceSection = () => {
  return (
   <section className="device-section">
      <h2 className="device-heading Header2 topMargin">Device (Hardware)</h2>
      <div className="devices-container">
        <div className="device-card">
          ...
          />
          <h3 className="device-title Header3 downMargin TextBlue">Sensor</h3>
          <p className="device-desc body3 TextGray3">
        ...
        <div className="device-card">
          <img
            ...
            className="device-image"
          />
          <h3 className="device-title Header3 downMargin TextBlue">Node</h3>
          <p className="device-desc body3 TextGray3">
        ...
        <div className="device-card">
          <img
            ...
            className="device-image"
          />
          <h3 className="device-title Header3 downMargin TextBlue">Energy Meter</h3>
          <p className="device-desc body3 TextGray3">
        ...
        <div className="device-card">
          <img
            ...
            className="device-image"
          />
          <h3 className="device-title Header3 downMargin TextBlue">Gateway</h3>
          <p className="device-desc body3 TextGray3">
            Gateways act as bridges between field devices (like sensors and meters) and the cloud platform. They collect data from various nodes and devices using protocols like Modbus, BACnet, or LoRaWAN, and transmit it to the cloud or local servers for analytics and visualization. Gateways are essential for ensuring seamless communication in energy management systems.
          </p>
        </div>
      </div>
    </section>
