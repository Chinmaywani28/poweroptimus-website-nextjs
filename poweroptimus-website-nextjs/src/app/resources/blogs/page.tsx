...
const Page = async () => {
  ...
  const cards = blogs?.map((b: any) => ({
    imageSrc: [
      ...
      "/form-building-management-system-outside-image.jpg",
      "/Blog_Image.png",
      "/resource-blog-image.jpg"
    ],
    title: b.title,
    description: b.metaDescription || "",
    date: b.date || "Nov 25",
  ...
  return (
    <>
      <Hero
        headerText="Explore Blogs on Environmental & Energy Trends"
        bodyText="Your hub for insights, ideas, and trends in environment and energy, curated to inform, inspire, and keep you ahead across industries, while keeping you updated on innovations, technologies, and best practices shaping a more sustainable future."
        image="/Resource_Blogs_Header_Vector_Image.svg"
        alt="EnvirOptimus Blogs"
      />
