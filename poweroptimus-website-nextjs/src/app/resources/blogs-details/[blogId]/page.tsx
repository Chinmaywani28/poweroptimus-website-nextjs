...
const imgObj: Record<string, string> = {
  'Driving-Energy-Efficiency-Environmental-Monitoring-and-Sustainability-with-Smart-Energy-Management':
    '/Blog_UnderPage_Smart Energy Management.png',

  'dont-Let-Your-Digital-Twin-Be-Just-a-Replica-Bring-It-to-Life':
    '/Blog_UnderPage_DIGITAL TWIN.jpg',

  'From-Building-Management-Systems-to-Intelligent-Operations-The-Next-Evolution-of-Smart-Facilities':
    '/from-building-management-system-inside-image.jpg',

  'The-Real-Cost-of-Not-Knowing-What-Your-Building-Is-Doing-Right-Now':
    '/bloog-four-image-four.jpg',

  'The-Shift-from-Reactive-Control-Systems-to-Proactive-Optimization':
    '/resource-blog-shift-two.png',
};
...
const Page = async ({ params }: Props) => {
  ...
  // Fetch blog on the server
  const selectedBlog: any = await getBlogByUrlId(blogId);
      ...
      <section className="blog-details-section">
        <div className="blog-layout">
          ...
          <div className="main-column">
            ...
            {/* Blog Content */}
            <article className="blog-text marTopGlobal">
          ...
          <aside className="sidebar">
            ...
            <div className="recent-blogs">
              ...
              <div className="recent-blog-list">
                ...
                <div>
                  <a
                    href="/resources/blogs-details/Driving-Energy-Efficiency-Environmental-Monitoring-and-Sustainability-with-Smart-Energy-Management"
                  ...
                  >
                    ...
                    <span className="blog-name">
                      Driving Energy Efficiency, Environmental Monitoring,
                      and Sustainability with Smart Energy Management
                    </span>
                  </a>
                </div>
                ...
                <div>
                  <a
                    href="/resources/blogs-details/dont-Let-Your-Digital-Twin-Be-Just-a-Replica-Bring-It-to-Life"
                    className="recent-blog-item"
                  >
                    <span className="arrow-icon">
                      <i className="ri-arrow-right-s-line"></i>
                ...
                <div>
                  <a
                    href="https://www.youtube.com/watch?v=WrFonQop5QY"
                    className="recent-blog-item"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    ...
                    <span className="blog-name">
                      EnvirOptimus - Energy Management and Environmental
                      Monitoring System
                    </span>
                  </a>
                </div>
