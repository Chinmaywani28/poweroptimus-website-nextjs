...
<p className="MsoNormal">For the purposes of this End-User License Agreement:</p>

<p className="MsoListParagraphCxSpFirst"><b>Agreement</b>
...
refers to: India
Customer refers to an individual accessing or using the Application or the company, or other legal entity on behalf of which such individual is accessing or using the Application, as applicable which has signified its acceptance of the terms and conditions of this Agreement</p>

<p className="MsoListParagraphCxSpMiddle"><b>Third-Party Services</b>,
means any services or content (including data, information, applications and other products services) provided by a third-party that may be displayed, included or made available by the Application.</p>


{/*  */}


<h2><span>Acknowledgment</span></h2>

<p className="MsoNormal">By clicking the "I Agree" button, downloading or using the Application, Customer is agreeing to be bound by the terms and conditions of this Agreement. If You do not agree to the terms of this Agreement, do not click on the "I Agree" button, do not download or do not use the Application.</p>

<p className="MsoNormal">This Agreement is a legal document between Customer and the Company and it governs your use of the Application made available to Customer by the Company.</p>

<p className="MsoNormal">The Application is licensed, not sold, to Customer by the Company for use strictly in accordance with the terms of this Agreement</p>


<h2><span>License</span></h2>

<h3><span>Scope of License</span></h3>


<p className="MsoNormal">The Company grants Customer a revocable, non-exclusive, non-transferable, limited license to download, install and use the Application strictly in accordance with the terms of this Agreement.</p>

<p className="MsoNormal">The license that is granted to Customer by the Company is solely for your personal, non-commercial purposes strictly in accordance with the terms of this Agreement.</p>



<h2><span>Third-Party Services</span></h2>


<p className="MsoNormal">The Application may display, include or make available third-party content (including data, information, applications and other products services) or provide links to third-party websites or services.</p>

<p className="MsoNormal">Customer acknowledge and agree that the Company shall not be responsible for any Third-party Services, including their accuracy, completeness, timeliness, validity, copyright compliance, legality, decency, quality or any other aspect thereof. The Company does not assume and shall not have any liability or responsibility to Customer or any other person or entity for any Third-party Services.</p>


<p className="MsoNormal">Customer must comply with applicable Third parties' Terms of agreement when using the Application. Third-party Services and links thereto are provided solely as a convenience to Customer and Customer access and use them entirely at your own risk and subject to such third parties' Terms and conditions.</p>
...
<p className="MsoNormal">Customer Responsibilities and Prohibited Actions.</p>

<p className="MsoNormal">(a) Remarketing of Application -Customer will not cause or permit the loan, publication, transfer of possession (whether by sale, exchange, gift, operation of law or otherwise) of the Application, in whole or in part, to or for any third party, and/or use of the Application as a service bureau.</p>


<p className="MsoNormal">(b) Transfer of Application - Unless specifically allowed by the terms of this Agreement or as may be required by applicable law, Customer may not distribute, rent, loan, lease, sell, sublicense or otherwise transfer all or any portion of the Application, or any rights granted in this Agreement, to any other person without the prior written consent of Company.</p>

<p className="MsoNormal">(c) Reverse Engineering or Modifying the Application
Prohibitions - Customer will not reverse engineer, decompile, translate, disassemble, or otherwise attempt to discover the source code of the Application. The prohibition against modifying or reverse engineering the Application does not apply to the extent that Customer is allowed to do so by applicable law.</p>

<p className="MsoNormal">(d) Authorized Agents; Indemnity. In addition to its own responsibility for compliance with the terms of this Agreement, Customer will ensure that Authorized Agents comply with the terms of this Agreement. Customer hereby agrees to indemnify Company from and against any and all liabilities, losses, claims, costs and/or expenses incurred by Company and/or its affiliates as a result of any violation of the terms of this Agreement by any Authorized Agent.</p>
...
<p className="MsoNormal">Upon termination of this Agreement, Customer shall cease all use of the Application and delete all copies of the Application from your Device.</p>
...
<p className="MsoNormal">Customer agree to indemnify and hold the Company and its parents, subsidiaries, affiliates, officers, employees, agents, partners and licensors (if any) harmless from any claim or demand, including reasonable attorneys' fees, due to or arising out of your: (a) use of the Application; (b) violation of this Agreement or any law or regulation; or (c) violation of any right of a third party.</p>


<h2><span>No Warranties</span></h2>

<p className="MsoNormal">The Application is provided to Customer "AS IS" and "AS AVAILABLE" and with all faults and defects without warranty of any kind. To the maximum extent permitted under applicable law, the Company, on its own behalf and on behalf of its affiliates and its and their respective licensors and service providers, expressly disclaims all warranties, whether express, implied, statutory or otherwise, with respect to the Application, including all implied warranties of merchantability, fitness for a particular purpose, title and non-infringement, and warranties that may arise out of course of dealing, course of performance, usage or trade practice. Without limitation to the foregoing, the Company provides no warranty or undertaking, and makes no representation of any kind that the Application will meet your requirements, achieve any intended results, be compatible or work with any other software, applications, systems or services, operate without interruption, meet any performance or reliability standards or be error free or that any errors or defects can or will be corrected.</p>

<p className="MsoNormal">Without limiting the foregoing, neither the Company nor any of the company's provider makes any representation or warranty of any kind, express or implied: (i) as to the operation or availability of the Application, or the information, content, and materials or products included thereon; (ii) that the Application will be uninterrupted or error-free; (iii) as to the accuracy, reliability, or currency of any information or content provided through the Application; or (iv) that the Application, its servers, the content, or e-mails sent from or on behalf of the Company are free of viruses, scripts, trojan horses, worms, malware, timebombs or other harmful components.</p>

<p className="MsoNormal">Some jurisdictions do not allow the exclusion of certain types of warranties or limitations on applicable statutory rights of a consumer, so some or all of the above exclusions and limitations may not apply to Customer. But in such a case the exclusions and limitations set forth in this section shall be applied to the greatest extent enforceable under applicable law. To the extent any warranty exists under law that cannot be disclaimed, the Company shall be solely responsible for such warranty.</p>

<h2><span>Limitation of Liability</span></h2>


<p className="MsoNormal">Notwithstanding any damages that Customer might incur, the entire liability of the Company and any of its suppliers under any provision of this Agreement and your exclusive remedy for all of the foregoing shall be limited to the amount actually paid by You for the Application or through the Application or 100 USD if Customer haven't purchased anything through the Application.</p>


<p className="MsoNormal">To the maximum extent permitted by applicable law, in no event shall the Company or its suppliers be liable for any special, incidental, indirect, or consequential damages whatsoever (including, but not limited to, damages for loss of profits, loss of data or other information, for business interruption, for personal injury, loss of privacy arising out of or in any way related to the use of or inability to use the Application, third-party software and/or third-party hardware used with the Application, or otherwise in connection with

any provision of this Agreement), even if the Company or any supplier has been advised of the possibility of such damages and even if the remedy fails of its essential purpose.</p>

<p className="MsoNormal">Some states/jurisdictions do not allow the exclusion or limitation of incidental or consequential damages, so the above limitation or exclusion may not apply to Customer</p>

<p className="MsoNormal">Neither party may make a claim under this Agreement arising out of an event or events that occurred more than two (2) years after the event is, or should have been, discovered by the party making the claim.</p>
...
<p className="MsoNormal">If any provision of this Agreement is held to be unenforceable or invalid, such provision will be changed and interpreted to accomplish the objectives of such provision to the greatest extent possible under applicable law and the remaining provisions will continue in full force and effect.</p>


<h3><span>Waiver</span></h3>


<p className="MsoNormal">Except as provided herein, the failure to exercise a right or to require performance of an obligation under this Agreement shall not effect a party's ability to exercise such right or require such performance at any time thereafter nor shall the waiver of a breach constitute a waiver of any subsequent breach.</p>

<h3><span>Product Claims</span></h3>


<p className="MsoNormal">The Company does not make any warranties concerning the Application.</p>

<h3><span>United States Legal Compliance</span></h3>
<p className="MsoNormal">Customer represent and warrant that (i) Customer are not located in a country that is subject to the United States government embargo, or that has been designated by the United States government as a "terrorist supporting" country, and (ii) You are not listed on any United States government list of prohibited or restricted parties.</p>


<h3><span>Changes to this Agreement</span></h3>
<p className="MsoNormal">The Company reserves the right, at its sole discretion, to modify or replace this Agreement at any time. If a revision is material we will provide at least 30 days' notice prior to any new terms taking effect. What constitutes a material change will be determined at the sole discretion of the Company.</p>

<p className="MsoNormal">By continuing to access or use the Application after any revisions become effective, Customer agree to be bound by the revised terms. If Customer do not agree to the new terms, Customer are no longer authorized to use the Application.</p>

{/*  */}

<h2><span>Governing Law</span></h2>

<p className="MsoNormal">The laws of the Country, excluding its conflicts of law rules, shall govern this Agreement and your use of the Application. Your use of the Application may also be subject to other local, state, national, or international laws.</p>

<h2><span>Entire Agreement</span></h2>

<p className="MsoNormal">The Agreement constitutes the entire agreement between Customer and the Company regarding your use of the Application and supersedes all prior and contemporaneous written or oral agreements between Customer and the Company.</p>

<p className="MsoNormal">Customer may be subject to additional terms and conditions that apply when Customer use or purchase other Company's services, which the Company will provide to Customer at the time of such use or purchase.</p>
