...
<p className="MsoNormal">For the purposes of these Terms and Conditions:</p>
...
<p className="MsoListParagraphCxSpMiddle"><b>Account </b>
...
<p className="MsoListParagraphCxSpMiddle"><b>Feedback </b>
means feedback, innovations or suggestions sent by You regarding the
attributes, performance or features of our Service.</p>

<p className="MsoListParagraphCxSpMiddle"><b>Free
Trial </b> refers to a limited period of time that may be free when purchasing a
Subscription.</p>

<p className="MsoListParagraphCxSpMiddle"><b>In-app
Purchase </b> refers to the purchase of a product, item, service or Subscription
made through the Application and subject to these Terms and Conditions and/or
the Application Store's own terms and conditions.</p>

<p className="MsoListParagraphCxSpMiddle"><b>Service </b>
refers to the Application or the Website or both.</p>

<p className="MsoListParagraphCxSpMiddle"><b>Subscriptions </b>
refer to the services or access to the Service offered on a subscription basis
by the Company to You.</p>

<p className="MsoListParagraphCxSpMiddle"><b>Terms
and Conditions </b> (also referred as &quot;Terms&quot;) mean these Terms and
...
Social Media Service </b> means any services or content (including data,
...
<h2><span style={{fontFamily:'"Cambria", serif'}}>Acknowledgment</span></h2>

<p className="MsoNormal">These are the Terms and Conditions governing the use of this
...
<p className="MsoNormal">Your access to and use of the Service is conditioned on Your
acceptance of and compliance with these Terms and Conditions. These Terms and
Conditions apply to all visitors, users and others who access or use the Service.</p>

<p className="MsoNormal">By accessing or using the Service You agree to be bound by
...
<p className="MsoNormal">You represent that you are over the age of 18. The Company
does not permit those under 18 to use the Service.</p>

<p className="MsoNormal">Your access to and use of the Service is also conditioned on
...
<h2><span style={{fontFamily: '"Cambria", serif', color: 'black'}}>Subscriptions</span></h2>

<h3><span style={{fontFamily: '"Cambria", serif', color: 'black'}}>Subscription period</span></h3>

<p className="MsoNormal">The Service or some parts of the Service are available only
...
type of Subscription plan you select when purchasing the Subscription.</p>

<p className="MsoNormal">At the end of each period, Your Subscription will
automatically renew under the exact same conditions unless You cancel it or the
Company cancels it.</p>

<h3><span style={{fontFamily:'"Cambria", serif'}}>Subscription cancellations</span></h3>

<p className="MsoNormal">You may cancel Your Subscription renewal either through Your
...
<p className="MsoNormal">If the Subscription has been made through an In-app
Purchase, You can cancel the renewal of Your Subscription with the Application
Store.</p>

<h3><span style={{fontFamily:'"Cambria", serif'}}>Billing</span></h3>

<p className="MsoNormal">You shall provide the Company with accurate and complete
billing information including full name, address, state, zip code, telephone
number, and a valid payment method information.</p>

<p className="MsoNormal">Should automatic billing fail to occur for any reason, the
...
<h3><span style={{fontFamily:'"Cambria", serif'}}>Fee Changes</span></h3>

<p className="MsoNormal">The Company, in its sole discretion and at any time, may
modify the Subscription fees. Any Subscription fee change will become effective
at the end of the then-current Subscription period.</p>

<p className="MsoNormal">The Company will provide You with reasonable prior notice of
any change in Subscription fees to give You an opportunity to terminate Your
Subscription before such change becomes effective.</p>

<p className="MsoNormal">Your continued use of the Service after the Subscription fee
change comes into effect constitutes Your agreement to pay the modified
Subscription fee amount.</p>

<h3><span style={{fontFamily:'"Cambria", serif'}}>Refunds</span></h3>

<p className="MsoNormal">Except when required by law, paid Subscription fees are
non-refundable.</p>

<p className="MsoNormal">Certain refund requests for Subscriptions may be considered
...
request a refund, You may do so by contacting the Application Store directly.</p>

<h3><span style={{fontFamily: '"Cambria", serif', color: 'black'}}>Free Trial</span></h3>

<p className="MsoNormal">The Company may, at its sole discretion, offer a
Subscription with a Free Trial for a limited period of time.</p>

<p className="MsoNormal">You may be required to enter Your billing information in
order to sign up for the Free Trial.</p>

<p className="MsoNormal">If You do enter Your billing information when signing up for
...
fees for the type of Subscription You have selected.</p>

<p className="MsoNormal">At any time and without notice, the Company reserves the
right to (i) modify the terms and conditions of the Free Trial offer, or (ii)
cancel such Free Trial offer.</p>

<h2><span style={{fontFamily: '"Cambria", serif', color: 'black'}}>In-app Purchases</span></h2>

<p className="MsoNormal">The Application may include In-app Purchases that allow you
to buy products, services or Subscriptions.</p>

<p className="MsoNormal">More information about how you may be able to manage In-app
Purchases using your Device may be set out in the Application Store's own terms
and conditions or in your Device's Help settings.</p>

<p className="MsoNormal">In-app Purchases can only be consumed within the
...
redeemed for cash or other consideration or otherwise transferred.</p>

<p className="MsoNormal">If any In-app Purchase is not successfully downloaded or
does not work once it has been successfully downloaded, we will, after becoming
...
Application Store directly.</p>

<p className="MsoNormal">You acknowledge and agree that all billing and transaction
...
<p className="MsoNormal">If you have any payment related issues with In-app
Purchases, then you need to contact the Application Store directly.</p>

<h2><span style={{fontFamily:'"Cambria", serif'}}>User Accounts</span></h2>

<p className="MsoNormal">When You create an account with Us, You must provide Us
...
<p className="MsoNormal">You are responsible for safeguarding the password that You
...
<p className="MsoNormal">You agree not to disclose Your password to any third party.
You must notify Us immediately upon becoming aware of any breach of security or
unauthorized use of Your account.</p>

<p className="MsoNormal">You may not use as a username the name of another person or
...
<h2><span style={{fontFamily:'"Cambria", serif'}}>Content</span></h2>

<h3><span style={{fontFamily:'"Cambria", serif'}}>Your Right to Post Content</span></h3>

<p className="MsoNormal">Our Service allows You to post Content. You are responsible
for the Content that You post to the Service, including its legality,
reliability, and appropriateness.</p>

<p className="MsoNormal">By posting Content to the Service, You grant Us the right
...
<p className="MsoNormal">You represent and warrant that: (i) the Content is Yours
...
copyrights, contract rights or any other rights of any person.</p>

<h3><span style={{fontFamily:'"Cambria", serif'}}>Content Restrictions</span></h3>

<p className="MsoNormal">The Company is not responsible for the content of the
...
<p className="MsoNormal">You may not transmit any Content that is unlawful,
...
><span><span >
</span></span></span>Containing or installing any viruses, worms,
...
<h3><span style={{fontFamily:'"Cambria", serif'}}>Content Backups</span></h3>

<p className="MsoNormal">Although regular backups of Content are performed, the
Company does not guarantee there will be no loss or corruption of data.</p>

<p className="MsoNormal">Corrupt or invalid backup points may be caused by, without
limitation, Content that is corrupted prior to being backed up or that changes
during the time a backup is performed.</p>

<p className="MsoNormal">The Company will provide support and attempt to troubleshoot
...
<p className="MsoNormal">You agree to maintain a complete and accurate copy of any
Content in a location independent of the Service.</p>

<h2><span style={{fontFamily:'"Cambria", serif'}}>Copyright Policy</span></h2>

<h3><span style={{fontFamily:'"Cambria", serif'}}>Intellectual Property Infringement</span></h3>

<p className="MsoNormal">We respect the intellectual property rights of others. It is
Our policy to respond to any claim that Content posted on the Service infringes
a copyright or other intellectual property infringement of any person.</p>

<p className="MsoNormal">If You are a copyright owner, or authorized on behalf of
...
<h2><span style={{fontFamily:'"Cambria", serif'}}>Intellectual Property</span></h2>

<p className="MsoNormal">The Service and its original content (excluding Content
provided by You or other users), features and functionality are and will remain
the exclusive property of the Company and its licensors.</p>

<p className="MsoNormal">The Service is protected by copyright, trademark, and other
laws of both the Country and foreign countries.</p>

<p className="MsoNormal">Our trademarks and trade dress may not be used in connection
with any product or service without the prior written consent of the Company.</p>

<p className="MsoNormal">No title to or ownership in the Application is transferred
...
<p className="MsoNormal">You assign all rights, title and interest in any Feedback
...
<h2><span style={{fontFamily:'"Cambria", serif'}}>Links to Other Websites</span></h2>

<p className="MsoNormal">Our Service may contain links to third-party web sites or
services that are not owned or controlled by the Company.</p>

<p className="MsoNormal">The Company has no control over, and assumes no
...
<p className="MsoNormal">We strongly advise You to read the terms and conditions and
privacy policies of any third-party web sites or services that You visit.</p>

<h2><span style={{fontFamily:'"Cambria", serif'}}>Termination</span></h2>

<p className="MsoNormal">We may terminate or suspend Your Account immediately,
...
<p className="MsoNormal">Upon termination, Your right to use the Service will cease
immediately. If You wish to terminate Your Account, You may simply discontinue
using the Service.</p>

<h2><span style={{fontFamily:'"Cambria", serif'}}>Limitation of Liability</span></h2>

<p className="MsoNormal">Notwithstanding any damages that You might incur, the entire
...
the amount actually paid by You.</p>

<p className="MsoNormal">To the maximum extent permitted by applicable law, in no
...
<p className="MsoNormal">Some states do not allow the exclusion of implied warranties
...
<h2><span style={{fontFamily:'"Cambria", serif'}}>&quot;AS IS&quot; and &quot;AS
AVAILABLE&quot; Disclaimer</span></h2>

<p className="MsoNormal">The Service is provided to You &quot;AS IS&quot; and
...
<p className="MsoNormal">Without limiting the foregoing, neither the Company nor any
...
<p className="MsoNormal">Some jurisdictions do not allow the exclusion of certain
...
<h2><span style={{fontFamily:'"Cambria", serif'}}>Governing Law</span></h2>

<p className="MsoNormal">The laws of the Country, excluding its conflicts of law
rules, shall govern this Terms and Your use of the Service. Your use of the
Application may also be subject to other local, state, national, or
international laws.</p>

<h2><span style={{fontFamily:'"Cambria", serif'}}>Disputes Resolution</span></h2>

<p className="MsoNormal">If You have any concern or dispute about the Service, You
agree to first try to resolve the dispute informally by contacting the Company.</p>

<h2><span style={{fontFamily:'"Cambria", serif'}}>For Indian Users</span></h2>

<p className="MsoNormal">If You are an Indian consumer, you will benefit from any
mandatory provisions of the law of the country in which You are resident.</p>

<h2><span style={{fontFamily:'"Cambria", serif'}}>For European Union (EU) Users</span></h2>

<p className="MsoNormal">If You are a European Union consumer, you will benefit from
any mandatory provisions of the law of the country in which You are resident.</p>

<h2><span style={{fontFamily:'"Cambria", serif'}}>United States Federal Government End Use
Provisions</span></h2>

<p className="MsoNormal">If You are a U.S. federal government end user, our Service
is a &quot;Commercial Item&quot; as that term is defined at 48 C.F.R. 2.101.</p>

<h2><span style={{fontFamily:'"Cambria", serif'}}>United States Legal Compliance</span></h2>

<p className="MsoNormal">You represent and warrant that (i) You are not located in a
...
<h2><span style={{fontFamily:'"Cambria", serif'}}>Severability and Waiver</span></h2>

<h3><span style={{fontFamily:'"Cambria", serif'}}>Severability</span></h3>

<p className="MsoNormal">If any provision of these Terms is held to be unenforceable
...
<h3><span style={{fontFamily:'"Cambria", serif'}}>Waiver</span></h3>

<p className="MsoNormal">Except as provided herein, the failure to exercise a right
...
<h2><span style={{fontFamily:'"Cambria", serif'}}>Translation Interpretation</span></h2>

<p className="MsoNormal">These Terms and Conditions may have been translated if We
...
<h2><span style={{fontFamily:'"Cambria", serif'}}>Changes to These Terms and Conditions</span></h2>

<p className="MsoNormal">We reserve the right, at Our sole discretion, to modify or
...
<p className="MsoNormal">By continuing to access or use Our Service after those
...
<h2><span style={{fontFamily:'"Cambria", serif'}}>Contact Us</span></h2>

<p className="MsoNormal">If you have any questions about these Terms and Conditions,
